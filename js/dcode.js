...
(function($) {
    ...
    *---------------------------------------------*/
    ...
    jQuery('#navigation ul li.menu-item-has-children > a').after('<span className="child-link"><i className="fas fa-chevron-down"></i></span>');
    ...
    *---------------------------------------------*/
    if($(window).width() < 767 ){
        $('.st-tab-btn').each(function(){
            ...
            $('<div className="select-filter">'+ActiveTabName+'</div>').prependTo(this).find('.st-tab-btn');
        });
